...
const ProfileListItem = ({listIcon, listText}) => {
  return (
    <TouchableOpacity style={styles.listItem}>
      <FontAwesome5 name={listIcon} size={20} color='#000' style={styles.listIcon}/>
      <Text style={styles.listText}>{listText}</Text>
      <FontAwesome5 name="chevron-right" size={20} color='#000' style={styles.listArrow}/>
    </TouchableOpacity>
  );
};
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.body}>
          ...
          <Image source={require('../assets/profile.jpg')} style={styles.imageIcon}/>
          <Text style={styles.name}>Sarah Johnson</Text>
          <Text style={styles.email}>sarahj@gmail.com</Text>

          <View style={styles.streak}>
            <FontAwesome5 name="fire-alt" size={20} color='#fff' style={styles.streakIcon}/>
...
const styles = StyleSheet.create({
   ...
   streak: {flexDirection: 'row', alignItems: 'center', backgroundColor: 'red', padding: 10, marginBottom: 20, borderRadius: 20},
   streakIcon: {marginRight: 10},
   streakText: {color: '#fff', marginRight: 10},
   streakNb: {color: '#fff', fontWeight: 'bold', fontSize: 16},
   listItem: {flexDirection: 'row', alignItems: 'center', padding: 15, borderRadius: 10, marginBottom: 10, width: '90%'},
